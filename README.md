...
- 🦺 [FxxkXSS](https://github.com/Yeuoly/FxxkXSS) [⭐ 39 🕸️ 5](https://github.com/Yeuoly/FxxkXSS/stargazers) `Electron` `Vue` `NodeJS`
...
- 🍡 [BUUPWN](https://github.com/Yeuoly/buuctf_pwn) [⭐ 4 🕸️ 1](https://github.com/Yeuoly/buuctf_pwn/stargazers) `Python` `Linux` `pwn` `C`
